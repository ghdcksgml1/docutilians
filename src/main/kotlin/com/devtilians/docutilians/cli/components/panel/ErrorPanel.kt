...
/**
 * CHUCK_UI Error Panel
 * Cyberpunk-styled error display with neon red glow
 */
...
object ErrorPanel {
    fun of(errorPanelRequest: ErrorPanelRequest): Panel {
        ...
        return Panel(
            ...
            expand = false,
            title = Text("⚠ ${Colors.Raw.error("ERROR")} ${Colors.Raw.errorBright("▸")} ${Colors.Raw.textWhite(errorPanelRequest.title)}"),
